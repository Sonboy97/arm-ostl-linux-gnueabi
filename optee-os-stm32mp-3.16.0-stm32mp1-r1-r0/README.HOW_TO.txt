...
In the optee-os source directory (sources/*/optee-os-stm32mp-3.16.0-stm32mp1-r1-r0),
...
------------------------------------------------------
    ...
    Branch: 3.16.0-stm32mp1
    Revision: 3.16.0-stm32mp1-r1

    $ git clone https://github.com/STMicroelectronics/optee_os.git
    $ git checkout -b WORKING 3.16.0-stm32mp1-r1
