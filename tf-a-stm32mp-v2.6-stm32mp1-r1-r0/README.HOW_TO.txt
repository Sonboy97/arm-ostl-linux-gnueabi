...
In the TF-A source directory (sources/*/tf-a-stm32mp-v2.6-stm32mp1-r1-r0),
...
--------------------------------------------------
    ...
    Branch: v2.6-stm32mp1
    Revision: v2.6-stm32mp1-r1

    $ git clone https://github.com/STMicroelectronics/arm-trusted-firmware.git
    $ git checkout -b WORKING v2.6-stm32mp1-r1
