...
In the U-Boot source directory (sources/*/u-boot-stm32mp-v2021.10-stm32mp1-r1-r0),
...
----------------------------------------------------
    ...
    Branch: v2021.10-stm32mp1
    Revision: v2021.10-stm32mp1-r1

    $ git clone https://github.com/STMicroelectronics/u-boot.git
    $ git checkout -b WORKING v2021.10-stm32mp1-r1
...
or
    ...
    $ cd u-boot
    $ git checkout -b WORKING v2021.10
