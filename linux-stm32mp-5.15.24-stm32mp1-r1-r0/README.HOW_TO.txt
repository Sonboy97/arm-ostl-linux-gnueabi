...
In the kernel source directory (sources/*/linux-stm32mp-5.15.24-stm32mp1-r1-r0),
...
---------------------------------------------------------
    ...
    Branch: v5.15-stm32mp1
    Revision: v5.15-stm32mp1-r1

    $ git clone https://github.com/STMicroelectronics/linux.git
    $ git checkout -b WORKING v5.15-stm32mp1-r1
...
---------------------------------------------------------------
    ...
    $ cd linux-stable
    $ git checkout -b WORKING v5.15.24
